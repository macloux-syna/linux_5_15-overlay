...
IRQCHIP_DECLARE(dolphin_dhub_ictl,
		"syna,dolphin-dhub-irq", berlin_dhub_irq_init);
IRQCHIP_DECLARE(as470_dhub_ictl,
		"syna,as470-dhub-irq", berlin_dhub_irq_init);
IRQCHIP_DECLARE(myna2_dhub_ictl,
		"syna,myna2-dhub-irq", berlin_dhub_irq_init);
IRQCHIP_DECLARE(platypus_dhub_ictl,
		"syna,platypus-dhub-irq", berlin_dhub_irq_init);
