...
typedef enum {
	...
	DHUB_PASSSHM,
	DHUB_AUTOPUSH_EN,
	DHUB_CHANNEL_START_SEQ,
	DHUB_CHANNEL_CLEAR_SEQ,
	DHUB_2ND_CHANNEL_START_SEQ,
	DHUB_2ND_CHANNEL_CLEAR_SEQ,
	DHUB_BCM_SCHED_PUSHCMD,
	DHUB_BCM_SCHED_GETEMPTYSTS,
	DHUB_BCM_SCHED_SETMUX,
	DHUB_BCM_SCHED_AUTOPUSHCMD,
} DHUB_CMD_ID;
