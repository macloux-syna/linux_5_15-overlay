...
#define SHM_IOC_ION_ALLOC       _IOWR('s', 1, struct ion_cust_allocation_data)
...
#define SHM_IOC_DMABUF_ALLOC    _IOWR('s', 8, struct dmabuf_allocation_data)
#endif
